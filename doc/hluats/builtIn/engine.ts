const JassCommon = require("jass.common")
const JassGlobals = require("jass.globals")
const JassSlk = require("jass.slk")
const JassJapi = require("jass.japi")
...
export declare function c2i(idChar:string):number
export declare function i2c(id:number):string
